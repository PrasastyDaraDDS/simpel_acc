...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form id="createproduct-form" action="{{ '/stores/' . $store->id }}" method="POST"
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="mb-3">
                                <label class="form-label" for="product-title-input">Nama Toko</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="link" id="link"
                                    class="form-control @error('link') is-invalid @enderror" value="{{ old('link',$store->link) }}"
                                    required>
                                @error('link')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="address" id="address"
                                    class="form-control @error('address') is-invalid @enderror" value="{{ old('address',$store->address) }}"
                                    required>
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
