            ...
            <div class="h-100">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">Rp <span class="counter-value"
                                                data-target="{{ $totalPaymentSum }}">0</span>
                                        </h4>
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $totalOrder }}">0</span></h4>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $totalCustomer }}">0</span>
                                        </h4>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Produk Terbaru</h4>
                                <div class="flex-shrink-0">
                                    <button type="button" class="btn btn-soft-primary btn-sm">
                                        Export Report
                                    </button>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <div>
                                                                    ...
                                                                    <p class="text-muted mb-0">Selling Price : Rp
                                                                        {{ number_format($product->sell_price, 0, ',', '.') }}
                                                                    </p>
                                                                    {{-- show the buying price --}}
                                                                    <p class="text-muted mb-0">Buying Price : Rp
                                                                        {{ number_format($product->buying_price, 0, ',', '.') }}
                                                                    </p>
                                                                </div>
                                                                <div class="text-end mb-0 text-muted">
                                                                    by <cite
                                                                        title="Source Title">{{ $product->supplier->name }}</cite>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card">
                                    <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                                        <tbody>
                                            @foreach ($bestSellingProducts as $order)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-14 my-1 fw-normal">Rp
                                                        {{ number_format($product->sell_price, 0, ',', '.') }}</h5>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Item Terlaris</h4>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="card-body">
                                ...
                                <div id="chart-sunburst" data-colors='["--vz-priamry", "--vz-info"]' class="e-charts">
                                </div>
                            </div>
                        </div> <!-- .card-->
                    </div> <!-- .col-->
